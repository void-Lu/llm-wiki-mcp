...
from codegraph.codegraph_architecture import (
    ArchitectureIR,
    PipelineSnapshot,
    build_architecture,
    render_code_fact,
...
from codegraph.codegraph_policy import is_codegraph_frontmatter
from common.git_utils import get_git_revision
...
WORKSPACE_ROOT_ENV = "LLM_WIKI_WORKSPACE_ROOT"
...
def sync_codegraph(vault_root: str | Path, *, workspace_root: str | Path | None = None) -> dict[str, Any]:
    ...
    LLM_WIKI_WORKSPACE_ROOT environment variable. It never falls back
