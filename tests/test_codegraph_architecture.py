...
from netsuite_llm_wiki_mcp.codegraph_architecture import build_architecture, render_code_fact, render_pipeline
from netsuite_llm_wiki_mcp.codegraph_sync import GraphSnapshot
...
def test_language_entrypoint_adapters_and_unknown_schema(tmp_path: Path) -> None:
    ...
    assert {pipeline.entrypoint["id"] for pipeline in ir.pipelines} == {"js", "ts", "suite"}
